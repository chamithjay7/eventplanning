...
type Booking = {
    id: number;
    eventTitle: string;
    ticketTypeName?: string;  // Optional for old bookings
    quantity?: number;         // Optional for old bookings
    totalPrice?: number;       // Optional for old bookings
    status: string;
    createdAt: string;
};
...
export default function MyBookings() {
    ...
    const openEdit = (booking: Booking) => {
        ...
        setEditQuantity(booking.quantity || 1); // Default to current quantity
    };
        ...
        <div>
                                            ...
                                            <div className="col-12">
                                                <div className="d-flex justify-content-between align-items-center p-2 bg-light rounded">
                                                    <div>
                                                        ...
                                                        <div className="fw-semibold">{booking.ticketTypeName || "N/A"}</div>
                                                    </div>
                                                    <div className="text-end">
                                                        <small className="text-muted">Quantity</small>
                                                        <div className="fw-bold text-primary fs-5">{booking.quantity || 0}</div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-12">
                                                <div className="alert alert-success mb-0">
                                                    <div className="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <span className="fs-4 fw-bold">
                                                            Rs. {booking.totalPrice ? booking.totalPrice.toLocaleString() : "N/A"}
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
            ...
            {viewBooking && (
                ...
                >
                    <div className="row g-3">
                        ...
                        <div className="col-md-6">
                            <div className="text-muted small mb-1">Ticket Type</div>
                            <div className="fw-semibold">{viewBooking.ticketTypeName || "N/A"}</div>
                        </div>
                        <div className="col-md-6">
                            <div className="text-muted small mb-1">Quantity</div>
                            <div className="fw-semibold">{viewBooking.quantity || 0}</div>
                        </div>
                        <div className="col-12">
                            <div className="text-muted small mb-1">Total Price</div>
                            <div className="fw-bold text-success fs-4">
                                Rs. {viewBooking.totalPrice ? viewBooking.totalPrice.toLocaleString() : "N/A"}
                            </div>
                        </div>
                        <div className="col-12">
            ...
            {editBooking && (
                ...
                >
                    ...
                    <div className="mb-3">
                        <div className="text-muted small mb-1">Ticket Type</div>
                        <div className="fw-semibold">{editBooking.ticketTypeName || "N/A"}</div>
                    </div>
                    <div className="mb-3">
                        <div className="alert alert-info mb-0">
                            <div className="d-flex justify-content-between align-items-center">
                                <span className="fw-semibold">Current Quantity:</span>
                                <span className="fs-5 fw-bold text-primary">{editBooking.quantity || 0}</span>
                            </div>
                        </div>
                    </div>
                    <div className="mb-3">
